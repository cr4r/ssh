...
edit_squid () {
msg -azu "$(fun_trans "Setel ulang port SQUID")"
msg -bar
...
sleep 1s
msg -bar
msg -azu "$(fun_trans "Setel ulang port")"
msg -bar
}
edit_apache () {
msg -azu "$(fun_trans "Setel ulang port APACHE")"
msg -bar
...
edit_openssh () {
msg -azu "$(fun_trans "Setel ulang port OPENSSH")"
msg -bar
...
main_fun () {
msg -ama " $(fun_trans "Layanan aktif port")"
msg -bar
mine_port5
msg -bar
...
for((a=1; a<=$i; a++)); do
[[ $squid = $a ]] && echo -ne "\033[1;32m [$squid] > " && msg -azu "$(fun_trans "SETEL ULANG PINTU SQUID")"
[[ $apache = $a ]] && echo -ne "\033[1;32m [$apache] > " && msg -azu "$(fun_trans "SETEL ULANG PINTU APACHE")"
[[ $openvpn = $a ]] && echo -ne "\033[1;32m [$openvpn] > " && msg -azu "$(fun_trans "SETEL ULANG PINTU OPENVPN")"
[[ $dropbear = $a ]] && echo -ne "\033[1;32m [$dropbear] > " && msg -azu "$(fun_trans "SETEL ULANG PINTU DROPBEAR")"
[[ $ssh = $a ]] && echo -ne "\033[1;32m [$ssh] > " && msg -azu "$(fun_trans "SETEL ULANG PINTU SSH")"
done
msg -bar
while true; do
echo -ne "\033[1;37m$(fun_trans "Pilih=> "): " && read selection
tput cuu1 && tput dl1

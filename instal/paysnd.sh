...
if [[ $retorno_ = "" ]]; then {
	echo -e "\n$barra"
	echo -e "\033[1;31m $(fun_trans ${id} "ERROR")!  $(fun_trans ${id} "Tidak ada tanggapan yang diterima dari server, periksa proxy Anda")!"
	echo -e "$barra"
	exit 0
	}
fi	
...
fun_error () {
echo -e "\033[1;31m $(fun_trans ${id} "Host Salah")!"
echo -e "$barra"
exit 0
}
#Proxy
...
#HTTP
echo -ne "\033[1;37m $(fun_trans ${id} "Verifikasi Proxy"): [."
...
err_fun () {
echo -e "\033[1;31m $(fun_trans ${id} "Operasi invalid")!"
exit
}
gerar_pay () {
valor2="127.0.0.1"
unset valor1
while [[ ${valor1} = "" ]]; do
echo -ne "\033[1;37m $(fun_trans ${id} "Tujuan Host"): " && read valor1
tput cuu1 && tput dl1
done
[[ -z "$valor1" ]] && err_fun
unset valor3
echo -e "\033[1;32m  $(fun_trans ${id} "Metode daftar permintaan")\033[1;37m "
echo -e "$barra"
...
echo -e "$barra"
while [[ ${valor3} != [1-7] ]]; do
echo -ne "\033[1;37m $(fun_trans ${id} "Pilih"): " && read valor3
tput cuu1 && tput dl1
done
tput cuu1 && tput dl1
tput cuu1 && tput dl1
...
unset valor4
echo -e "\033[1;32m  $(fun_trans ${id} "Metode koneksi")\033[1;37m "
echo -e "$barra"
echo -e " 1-REALDATA   2-NETDATA   3-RAW            "
echo -e "$barra"
while [[ ${valor4} != [1-3] ]]; do
echo -ne "\033[1;37m $(fun_trans ${id} "Pilih"): " && read valor4
tput cuu1 && tput dl1
done
tput cuu1 && tput dl1
tput cuu1 && tput dl1
...
echo -ne "\033[1;37m $(fun_trans ${id} "Masukkan Proxy"): " && read hostprox
tput cuu1 && tput dl1
done
unset portx
while [[ ${portx} != +([0-9]) ]]; do
echo -ne "\033[1;37m $(fun_trans ${id} "Masukkan Port"): " && read portx
tput cuu1 && tput dl1
done
proxy_fun
}
paysnd_fun () {
echo -e "\033[1;33m PAYLOAD $(fun_trans ${id} "Pembuatan Payload") \033[1;32m"
echo -e "$barra"
while true; do
echo -e "${cor[4]} [1] > \033[1;37m$(fun_trans ${id} "Mencoba Payload")"
echo -e "${cor[4]} [2] > \033[1;37m$(fun_trans ${id} "Coba dengan Generated PAYLOAD")"
echo -e "${cor[4]} [0] > \033[1;37m$(fun_trans ${id} "Kembali")\n${barra}"
while [[ ${opx} != @(0|[1-2]) ]]; do
echo -ne "${cor[0]}$(fun_trans ${id} "Pilih"): \033[1;37m" && read opx
tput cuu1 && tput dl1
done
tput cuu1 && tput dl1
tput cuu1 && tput dl1
...
case $opx in
	...
	unset payloadx
	while [[ ${payloadx} = "" ]]; do
	echo -ne "\033[1;37m $(fun_trans ${id} "Masukkan Payload"): " && read payloadx
	done
	#Brute
	unset hostprox
	while [[ ${hostprox} != +([0-9.]) ]]; do
...
echo -ne " \033[1;31m$(fun_trans ${id} "jawab"): \033[1;32m"

...
openssh () {
msg -verd " $(fun_trans "OPENSSH AUTO-CONFIGURATION by CR4R")"
msg -bar
fun_ip
msg -ne " $(fun_trans "Apakah ip sudah benar")"; read -p ": " -e -i $IP ip
msg -bar
msg -bra " $(fun_trans "Menu Instalasi PORT 22 ")"
msg -bar
...
fun_ssh
fun_eth
msg -bra " $(fun_trans "Reset Service")"
service ssh restart > /dev/null 2>&1
msg -bar
msg -ama " $(fun_trans "SSH DIKONFIGURASI DENGAN SUKSES")"
msg -bar
return 0
}
openssh